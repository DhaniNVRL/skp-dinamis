    ...
    <div class="w-full max-w-lg overflow-hidden rounded-xl bg-white shadow-xl">
        <form id="resetProfileForm" method="POST">
            ...
            <div class="flex items-center justify-between border-b border-gray-200 px-6 py-4">
                <div>
                    <h3 class="text-lg font-semibold text-gray-900">Reset Account User</h3>
            ...
            <div class="p-6">
                <p class="text-sm text-gray-700">Reset account <strong id="resetProfileUserName" class="text-gray-900"></strong>?</p>

                <div class="mt-4 rounded-xl border border-red-200 bg-red-50 p-4 text-sm text-red-700">
                    <div class="flex items-start gap-3">
                        <i class="fa-solid fa-triangle-exclamation mt-0.5"></i>
                        <div>
                            <p class="font-semibold">Dampak Reset Account:</p>
            ...
            <div class="flex justify-end gap-3 border-t border-gray-200 bg-gray-50 px-6 py-4">
                ...
                <button type="submit" class="rounded-lg bg-red-600 px-4 py-2 text-sm font-medium text-white hover:bg-red-700"><i class="fa-solid fa-user-rotate mr-2"></i>Ya, Reset Account</button>
            </div>
        </form>
    </div>
</div>
