<div id="deleteModal" data-modal class="fixed inset-0 z-50 hidden items-center justify-center bg-black/50 p-4">
    <div class="w-full max-w-md overflow-hidden rounded-xl bg-white shadow-xl">
        <form id="deleteForm" method="POST">
            ...
            <div class="flex items-center justify-between border-b border-gray-200 px-6 py-4">
                ...
                <button type="button" data-modal-close="deleteModal" class="text-gray-400 hover:text-red-600"><i class="fa-solid fa-xmark text-xl"></i></button>
            </div>
