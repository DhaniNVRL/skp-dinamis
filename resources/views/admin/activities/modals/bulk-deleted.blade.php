...
>
    <div class="w-full max-w-md overflow-hidden rounded-xl bg-white shadow-xl">
        <form id="bulkDeleteForm" method="POST" action="{{ route('activities.bulkDelete') }}">
            @csrf
            @method('DELETE')

            <div class="flex items-center justify-between border-b border-gray-200 px-6 py-4">
                <div>
                    <h3 class="text-lg font-semibold text-gray-900">Hapus Activity Terpilih</h3>
                    <p class="mt-1 text-sm text-gray-500">Tindakan ini tidak dapat dibatalkan.</p>
                </div>
                <button type="button" data-modal-close="bulkDeleteModal" class="text-gray-400 hover:text-red-600">
            ...
            <div class="p-6">
                <p class="text-sm text-gray-700">
                    Yakin ingin menghapus <strong id="bulkDeleteCount">0</strong> Activity?
                </p>
