...
>
    <div class="max-h-[90vh] w-full max-w-4xl overflow-y-auto rounded-xl bg-white shadow-xl">
        ...
        <div class="flex items-center justify-between border-b border-gray-200 px-6 py-4">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">
                    Tambahkan satu atau beberapa activity sekaligus.
                </p>
            </div>

            <button
                type="button"
                data-modal-close="createActivityModal"
        ...
        {{-- Form --}}
        <form
            action="{{ route('admin.storeactivity') }}"
            method="POST"
        >
            @csrf
            ...
            <div class="overflow-x-auto p-6">
                ...
                <div class="overflow-hidden rounded-lg border border-gray-200">
                    ...
                    <table
                        id="activityCreateTable"
                        data-dynamic-table
                        data-template="createActivityRowTemplate"
            ...
            <div class="flex items-center justify-between border-t border-gray-200 bg-gray-50 px-6 py-4">
                ...
                <button
                    type="button"
                    data-add-row="activityCreateBody"
