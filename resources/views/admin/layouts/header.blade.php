<header class="fixed top-0 left-0 right-0 h-16 bg-blue-700 text-white px-6 flex justify-between items-center z-50">
    ...
    {{-- <div class="flex items-center space-x-3">
        <img src="{{ asset('images/logo1.png') }}" class="w-20 h-20 object-contain" alt="">
        <img src="{{ asset('images/logo3.png') }}" class="w-20 h-20 object-contain" alt="">
        <img src="{{ asset('images/logo2.png') }}" class="w-20 h-20 object-contain" alt="">
    </div> --}}
    <div class="flex items-center space-x-3 h-20">
        <img src="{{ asset('images/logo4.png') }}" style="height: 70%;" class="object-contain" alt="">
    </div>
