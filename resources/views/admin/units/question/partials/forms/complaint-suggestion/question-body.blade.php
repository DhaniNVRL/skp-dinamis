...
@switch($questionTypeId)
    ...
    @case(1)
        @include(
            'admin.units.question.partials.forms.complaint-suggestion.options.title',
            [
                'question' => $question,
                'form' => $form,
            ]
    ...
    {{-- Pertanyaan Keluhan dan Saran --}}
    @case(2)
        @include(
            'admin.units.question.partials.forms.complaint-suggestion.options.two-textareas',
            [
                'question' => $question,
                'form' => $form,
            ]
