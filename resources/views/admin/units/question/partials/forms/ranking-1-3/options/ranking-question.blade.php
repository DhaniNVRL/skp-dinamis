        ...
        <div class="flex min-w-0 items-start gap-3">
            ...
            <div class="min-w-0">
                ...
                <p class="mt-1 text-xs text-gray-500">
                    Pilih dan urutkan 3 pilihan terbaik.
                </p>
            ...
            <div class="flex items-start gap-3">
                ...
                <div>
                    ...
                    <p class="mt-1 text-xs leading-5 text-violet-700">
                        Ranking 1 merupakan prioritas tertinggi dan ranking 3
        ...
        <div class="space-y-3">
            ...
            @empty
                ...
                <div class="rounded-xl border border-dashed border-gray-300 bg-gray-50 p-6 text-center">
                    ...
                    <p class="mt-1 text-xs text-gray-500">
                        Tambahkan minimal 3 option agar responden dapat
                        menentukan ranking 1 sampai 3.
                    </p>
