                            ...
                            <td class="px-4 py-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="mt-0.5 text-xs text-gray-500">Tambahkan nama kompetitor untuk mengaktifkan penilaian skala 1–7.</p>
                                    </div>
                                </div>
                            </td>
                                <td class="px-2 py-4 text-center">
                                    ...
                                    <input type="radio" disabled aria-label="Nilai 6" class="h-4 w-4 border-gray-300 text-violet-600">
                                </td>                                <td class="px-2 py-4 text-center">
                                    <input type="radio" disabled aria-label="Nilai 7" class="h-4 w-4 border-gray-300 text-violet-600">
