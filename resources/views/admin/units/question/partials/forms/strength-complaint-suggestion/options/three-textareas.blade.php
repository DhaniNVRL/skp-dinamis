        ...
        <div class="flex min-w-0 items-start gap-3">
            ...
            <div class="min-w-0">
                ...
                <p class="mt-1 text-xs text-gray-500">
                    Jawaban berupa Keunggulan, Keluhan, dan Saran.
                </p>
            ...
            <div class="rounded-xl border border-emerald-200 bg-emerald-50/60 p-4">
                ...
                <div class="mb-3 flex items-center gap-2">
                    ...
                    <span
                        class="inline-flex h-8 w-8 items-center
                               justify-center rounded-lg bg-emerald-100
                               text-emerald-600"
                    >
                ...
                <textarea
                    ...
                    class="w-full resize-none rounded-lg border
                           border-emerald-200 bg-white p-3
                           text-sm text-gray-700"
                    placeholder="Responden menuliskan keunggulan, pencapaian, atau aspek positif yang sudah berjalan dengan baik..."
                ></textarea>
