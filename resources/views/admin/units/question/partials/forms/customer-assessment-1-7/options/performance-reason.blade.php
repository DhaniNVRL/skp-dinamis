        ...
        <div class="flex min-w-0 items-start gap-3">
            ...
            <div>
                ...
                <p class="mt-1 text-xs text-gray-500">
                    Penilaian Kepentingan & Kinerja dengan alasan Kinerja
                </p>
            </div>
        </div>
    ...
    <div class="p-5">
        ...
        <div class="mt-5">
            ...
            <p class="mb-3 text-xs text-gray-500">
                Ditampilkan kepada responden jika nilai Kinerja lebih dari 0.
            </p>
            ...
            <textarea
                ...
                placeholder="Responden menuliskan alasan penilaian Kinerja..."
            ></textarea>
