...
<div class="max-w-xl mx-auto mt-10 bg-white shadow-md rounded px-8 pt-6 pb-8">
  ...
  <form action="{{ route('questtype.update', $questtypes->id) }}" method="POST">
    ...
    <div class="mb-4">
      ...
      <input type="text" name="name" id="name" value="{{ old('name', $questtypes->name) }}"
    ...
    <div class="mb-4">
      ...
      <input type="text" name="description" id="description" value="{{ old('description', $questtypes->description) }}"
