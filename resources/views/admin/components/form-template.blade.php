        ...
        <div class="p-4">
            ...
            <div data-content="manual">
                <form id="manualForm" method="POST">
                    ...
                    <div id="rows">
                        ...
                        <div class="w-full">
                            <input type="text" name="no_urut[]" placeholder="No Urut" class="border p-2 w-full" required>
                        </div>
                        <div class="w-full">
                            <input type="text" name="name[]" placeholder="Question" class="border p-2 w-full" required>
                        </div>
                        <div class="w-full">
                            <select name="formtype[]" required class="validate-required border rounded px-4 py-2 w-full">
                                ...
                                @foreach($formtypes as $formtype)
                                    <option value="{{ $formtype->id }}">{{ $formtype->name }}&mdash;{{$formtype->description}}</option>
                                @endforeach
                            </select>
                        </div>
            ...
            <div data-content="excel" class="hidden">
                <form id="excelForm" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="group_ids" value="{{ $groups->id }}">
