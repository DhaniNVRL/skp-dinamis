<template id="competitor-template">
    ...
    <div class="p-4">
        ...
        <div data-content="manual">
            <form id="manualForm" method="POST" action="{{ route('competitor.store') }}">
                @csrf
                <input type="hidden" name="group_id" id="group_id_input" value="{{ $groups->id ?? '' }}">
                ...
                <div id="rows"> <!-- ID diperbaiki -->
                    <div class="row flex gap-2 mb-2" id="answerRows">
                        <div class="w-full">
                            <textarea name="name[]" placeholder="Name Kompetitor" class="border p-2 w-full" required></textarea>
                        </div>
