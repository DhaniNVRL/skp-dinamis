    ...
    <table class="min-w-full bg-white border border-gray-200">
      <thead>
        <tr class="bg-gray-100 text-center">
          ...
          <th class="py-2 px-4 border-b w-[200px]">No</th>
          <th class="py-2 px-4 border-b w-[200px]">Name</th>
          <th class="py-2 px-4 border-b w-[200px]">Group</th>
      ...
      <tbody id="activityTable">
        ...
        <tr class="cursor-pointer hover:bg-gray-100 transition" >
          ...
          <td class="py-2 px-4 border-b">{{$question->no}}</td>
          <td class="py-2 px-4 border-b">{{$question->name}}</td>
          <td class="py-2 px-4 border-b">{{$question->group->name}}</td>
          <td class="py-2 px-4 border-b">{{$question->updated_at}}</td>
        </tr>
        @endforeach
      </tbody>
    </table>
